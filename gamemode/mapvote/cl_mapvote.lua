...
net.Receive("ter_map_table_init", function(length)
...
net.Receive("tter_votemap_start", function(length)
	GAMEMODE:OpenMapVote()
end)

net.Receive("tter_votemap_update", function(length)
...
net.Receive("tter_forcemap_open", function(length)
